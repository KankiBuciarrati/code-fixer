...
import { AlertCircle, Info, Zap, Calculator, ArrowRight } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      {signalData && (
        ...
        >
          <div className="p-5 rounded-xl bg-signal-amber/5 border border-signal-amber/20">
            <div className="flex items-center gap-2 mb-2">
              <Zap className="text-signal-amber" size={18} />
              <h3 className="font-bold text-foreground text-sm">Énergie</h3>
            </div>
            <p className="text-2xl font-bold text-foreground font-mono">
              {energy !== null ? energy.toExponential(4) : 'N/A'}
            </p>
            <p className="text-xs text-muted-foreground mt-1">E = ∫|x(t)|² dt</p>
          </div>
          ...
          <div className="p-5 rounded-xl bg-primary/5 border border-primary/20">
            ...
            <p className="text-xs text-muted-foreground mt-1">Type de signal</p>
          </div>
        </motion.div>
      )}
